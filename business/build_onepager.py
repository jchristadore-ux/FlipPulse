  ...
  <div class="cols">
    <div class="col">
      ...
      <div class="box">
        <ul>
          ...
          <li><b>20% of monthly profit</b> — high-water mark; upside, not in base totals*</li>
        </ul>
      </div>
    ...
    <div class="col">
      ...
      <ul>
        ...
        <li>Biggest upside lever: the <b>20% performance fee</b> — adds ~$38K/yr in the model even at conservative return assumptions.</li>
      </ul>
    </div>
  </div>

  <div class="disc">
    *Performance-fee revenue is illustrative and <b>unproven</b> — it assumes an average funded balance and monthly
    return set in the model, and is excluded from the base revenue/net figures above. All numbers are generated by
    <b>FlipPulse_Business_Model.xlsx</b> with fully editable inputs (pricing, growth, costs sourced mid-2026: Railway,
    Stripe, Claude, GitHub, Apple). This brief is a business projection, not investment advice or a securities offering;
    charging a percentage of trading profits may require regulatory/compliance review before launch.
  </div>
</div>
</body></html>"""
