"""
FlipPulse — Kalshi BTC 15-minute trading bot (production).

Single-customer template. Configure via environment variables (see .env.example).
Version history lives in CHANGELOG.md (MarkeyMachine lineage → FlipPulse).
"""
...
# How long to sleep between bookkeeping cycles while halted for the day
# (profit target / session stop). Shorter = faster UTC-rollover resume.
HALT_POLL_SECS        = _env_int("HALT_POLL_SECS", 300)
